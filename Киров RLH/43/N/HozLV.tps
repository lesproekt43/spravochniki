...
begin
  ResultValue := '0';
     ...
     if (@M1.HOZMER1=3211) then ResultValue := '3211'
else if (@M1.HOZMER1=3271) then ResultValue := '3271'
else if (@M1.HOZMER1=3275) then ResultValue := '3275'
else if (@M1.HOZMER1=3285) then ResultValue := '3285'

...
else if (@M1.HOZMER2=3274) OR (@M1.HOZMER1=3274) then ResultValue := '3275'
else if (@M1.HOZMER2=3285) OR (@M1.HOZMER1=3285) then ResultValue := '3285'
else if (@M1.HOZMER2=3282) OR (@M1.HOZMER1=3282) then ResultValue := '3282'
else if (@M1.HOZMER2=3202) OR (@M1.HOZMER1=3202) then ResultValue := '3282'
